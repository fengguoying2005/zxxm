...
public class CzygroupAction extends BaseAction<BaseIAO> {
		private Czygroup orggroup;
		private List<Czygroup> orggroups;
...
//				+"~" +JGPX								datas[9]
	...
	public IComplexPrintData getExcelPrintData() {
		...
		int i = 0;
		for (Czygroup _orggroup: orggroups) {
			i ++;
		...
		public void setOrggroup(Czygroup orggroup) {
				this.orggroup=orggroup;
		}
		public Czygroup getOrggroup(){
				return this.orggroup;
		}
		public void setOrggroups(List<Czygroup> orggroups) {
				this.orggroups=orggroups;
		}
		public List<Czygroup> getOrggroups(){
