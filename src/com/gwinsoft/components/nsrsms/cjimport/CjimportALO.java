...
import com.gwinsoft.components.nsrsms.cbimport.Cbimport;
import com.gwinsoft.components.nsrsms.cbimport.NSRDATAMX;
...
public class CjimportALO extends BaseALO {
	...
	protected void doService() {
		...
		for(int i = 0; i < sheets.length; i ++) {
			...
			}
			{
				...
				if(c0==null || !"纳税人编码".equals(c0.trim())|| c1==null || !"纳税人名称".equals(c1.trim())|| c2==null || !"手机号码".equals(c2.trim())|| c3==null || !"催缴日期起".equals(c3.trim())|| c4==null || !"催缴日期止".equals(c4.trim())|| c5==null || !"征收项目".equals(c5.trim())|| c6==null || !"征收品目".equals(c6.trim())|| c7==null || !"税款所属期起".equals(c7.trim())|| c8==null || !"税款所属期止".equals(c8.trim())|| c9==null || !"金额".equals(c9.trim())) {
					if(i==0) {
