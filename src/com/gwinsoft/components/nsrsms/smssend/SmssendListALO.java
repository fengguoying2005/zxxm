...
public class SmssendListALO extends BaseALO {

	protected void doService() {
		PageBean pageBean = reqEnv.getData("pageBean");
		DBPersistenceManager pm = this.getPM();
		StringBuffer sql = new StringBuffer("SELECT T.NSRDATA_LSH AS HID_LSH,T.* FROM SMS_NSRDATA T WHERE SMSTYPE_DM IN('01','02') ");
		...
		try {
			...
			GwinSoftUtil.translate(groups, "SHY", DMB.getTranslateStr(DMB.getDMB("USER_CACHE", "USER_MC")));
