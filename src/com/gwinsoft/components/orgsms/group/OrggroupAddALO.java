...
public class OrggroupAddALO extends BaseALO {
	...
	protected void doService() {
		...
		for(GROUPMX mx:tablemx) {
			...
			pm.executeUpdate("INSERT INTO ORG_GROUPMX(GROUPMX_LSH,GROUP_LSH,ORG_DM_JG,ORG_DM_BM,USER_DM,SJHM,LRRY_DM,XGRY_DM,LR_SJ,XG_SJ,ORG_MC_JG,ORG_MC_BM,USER_MC,ZW_DM,ZW_MC) VALUES(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)", mx);
		}
		pm.executeUpdate("INSERT INTO ORG_GROUP(GROUP_LSH,ORG_DM_JG,GROUP_NAME,GROUP_COUNT,LRRY_DM,XGRY_DM,LR_SJ,XG_SJ) VALUES(?,?,?,?,?,?,?,?)", orggroup);
		message="保存成功！";
