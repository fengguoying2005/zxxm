...
public class OrgsmssendAction extends BaseAction<BaseIAO> {
	private Orgsmssend orgsmssend;
	private List<Orgsmssend> orgsmssends;
	...
	public String toAdd() {
		...
		tablemx = new ArrayList<ORGMSG>();
		ORGMSG mx = new ORGMSG();
		tablemx.add(mx);
		return "add";
	}
...
//		}
	...
	public IComplexPrintData getExcelPrintData() {
		...
		int i = 0;
		for (Orgsmssend _orgsmssend : orgsmssends) {
			i++;
	...
	public void setOrgsmssend(Orgsmssend orgsmssend) {
		this.orgsmssend = orgsmssend;
	}

	public Orgsmssend getOrgsmssend() {
		return this.orgsmssend;
	}

	public void setOrgsmssends(List<Orgsmssend> orgsmssends) {
		this.orgsmssends = orgsmssends;
	}

	public List<Orgsmssend> getOrgsmssends() {
	...
	public List<ORGMSG> getTablemx() {
		return tablemx;
	}

	public void setTablemx(List<ORGMSG> tablemx) {
