...
import com.gwinsoft.components2.job.beans_js.FPZWCX_BEAN;
...
public class FPZWCX implements InterruptableJob {

	public void execute(JobExecutionContext arg0) throws JobExecutionException {
//		System.out.println("发票真伪查询");
		String type_dm = "FPZWCX";
		...
		try {
			...
			for(SMS_INBOX_BEAN bean:inboxs) {
				try {
					FPZWCX_BEAN sms = InboxUtil.SAVE_FPZWCX_BEAN(bean, pm);
					//启动短信发送队列
