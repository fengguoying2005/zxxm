...
import com.gwinsoft.components2.job.beans_js.TSJBCX_BEAN;
import com.gwinsoft.framework.db.DBHelper;
import com.gwinsoft.framework.db.DBPersistenceManager;

public class TSJBCX implements InterruptableJob {

	public void execute(JobExecutionContext arg0) throws JobExecutionException {
//		System.out.println("投诉举报");
		String type_dm = "TSJBCX";
		...
		try {
			...
			for(SMS_INBOX_BEAN bean:inboxs) {
				try {
					InboxUtil.SAVE_TSJBCX_BEAN(bean, pm);
					//启动短信发送队列
