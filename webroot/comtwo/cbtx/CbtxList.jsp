...
<script type="text/javascript">
            function next(event) {
                ...
                document.forms[0].action="<%=basePath%>comtwo/cbtx_"+event+".html";
...
<body onload="tablecloth('cbtxList');">
	<form id="myform" name="myform" action="cbtx" method="post">
			...
			<div class="span-24">
				...
				<div id="tablediv">
					<table width="100%" class="tablepanel" cellspacing="0">
						...
						<tr>
							<td class="tdtitle"><label for="FIND_KS_RQ"> 申报期限起 </label></td>
							<td><s:textfield cssClass="text" id="FIND_KS_RQ"
									name="FIND_KS_RQ"></s:textfield></td>
							<td class="tdtitle"><label for="FIND_JZ_RQ"> 申报期限止 </label></td>
				...
				<table class="record-list" id="cbtxList" name="cbtxList">
					<thead>
						<tr>
							<th>选择</th>
							<th>行</th>
							...
							<td colspan="9">
								<div align="left">
									<gwintag:page pageBeanName="pageBean"
										includes="FIND_SWJGBM,FIND_NSRSBM,FIND_NSRMC,FIND_SJLX,FIND_SBQX"
					...
					<tbody>
						<s:iterator value="cbtxs" status="stat">
							<tr
