...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="LSH" name="cbtx.LSH"
                                requireds="false" requiredsLength="0,36" labels="流水号" ></s:textfield>
						</td>
						<td class="tdtitle">
                            <label for="SWJGBM">
                                	税务机关
						...
						<td>
                            <s:select id="SWJGBM" name="cbtx.SWJGBM" list="orgmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="false" requiredsLength="0,50" labels="税务机关" ></s:select>
						</td>
</tr>
<tr>						<td class="tdtitle">
                            <label for="NSRSBM">
						...
						<td>
                            <s:textfield cssClass="text" id="NSRSBM" name="cbtx.NSRSBM"
						...
						<td>
                            <s:textfield cssClass="text" id="NSRMC" name="cbtx.NSRMC"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:select id="SJLX" name="cbtx.SJLX" list="jsrlxmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="false" requiredsLength="0,20" labels="手机类型" ></s:select>
						</td>
						<td class="tdtitle">
                            <label for="SJHM">
                                	手机号码
						...
						<td>
                            <s:textfield cssClass="text" id="SJHM" name="cbtx.SJHM"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="SMSINFO" name="cbtx.SMSINFO"
						...
						<td>
                            <s:textfield cssClass="text" id="SKSSQ" name="cbtx.SKSSQ"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="SKSSZ" name="cbtx.SKSSZ"
						...
						<td>
                            <s:textfield cssClass="text" id="SBQX" name="cbtx.SBQX"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="BZ" name="cbtx.BZ"
						...
						<td>
                            <s:textfield cssClass="text" id="FSZT_DM" name="cbtx.FSZT_DM"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="LR_SJ" name="cbtx.LR_SJ"
						...
						<td>
                            <s:textfield cssClass="text" id="FS_SJ" name="cbtx.FS_SJ"
