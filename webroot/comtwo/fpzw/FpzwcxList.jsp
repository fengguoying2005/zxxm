...
<script type="text/javascript">
            function next(event) {
                ...
                document.forms[0].action="<%=basePath%>comtwo/fpzwcx_"+event+".html";
...
<body onload="tablecloth('fpzwcxList');">
	<form id="myform" name="myform" action="fpzwcx" method="post">
		<div class="container" id="mainframe">
			...
			<div class="span-24">
				...
				<table class="record-list" id="fpzwcxList" name="fpzwcxList">
					<thead>
						<tr>
							<th>选择</th>
							<th>行</th>
							...
							<td colspan="11">
								<div align="left">
									<gwintag:page pageBeanName="pageBean"
										includes="FIND_SWJGBM,FIND_NSRSBM,FIND_NSRMC,FIND_SJHM,FIND_LR_SJ,FIND_LR_SJ2"
					...
					<tbody>
						<s:iterator value="fpzwcxs" status="stat">
							<tr
								...
								<td><s:property value="FPZL" /></td>
								<td><s:property value="FPDM" /></td>
								<td><s:property value="FPHM" /></td>
								<td><s:property value="FP_RQ" /></td>
								<td><s:property value="FP_JE" /></td>
							</tr>
						</s:iterator>
					</tbody>
				</table>
