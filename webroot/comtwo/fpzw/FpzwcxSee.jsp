					...
					<table width="100%" class="tablepanel" cellspacing="0">
						<tr>
							...
							<td><s:select disabled="true" id="SWJGBM"
									name="fpzwcx.SWJGBM" list="orgmap" headerKey=""
							...
							<td><s:textfield cssClass="text" id="NSRSBM"
									name="fpzwcx.NSRSBM" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="NSRMC"> 纳税人名称 </label></td>
							<td><s:textfield cssClass="text" id="NSRMC"
									name="fpzwcx.NSRMC" readonly="true"></s:textfield></td>
							<td class="tdtitle"><label for="SJHM"> 手机号码 </label></td>
							<td><s:textfield cssClass="text" id="SJHM"
									name="fpzwcx.SJHM" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="FPZL"> 发票种类 </label></td>
							<td><s:textfield cssClass="text" id="FPZL"
									name="fpzwcx.FPZL" readonly="true"></s:textfield></td>
							<td class="tdtitle"><label for="FPDM"> 发票代码 </label></td>
							<td><s:textfield cssClass="text" id="FPDM"
									name="fpzwcx.FPDM" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="FPHM"> 发票号码 </label></td>
							<td><s:textfield cssClass="text" id="FPHM"
									name="fpzwcx.FPHM" readonly="true"></s:textfield></td>
							<td class="tdtitle"><label for="FP_RQ"> 发票日期 </label></td>
							<td><s:textfield cssClass="text" id="FP_RQ"
									name="fpzwcx.FP_RQ" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="FP_JE"> 发票金额 </label></td>
							<td><s:textfield cssClass="text" id="FP_JE"
									name="fpzwcx.FP_JE" readonly="true"></s:textfield></td>
							<td class="tdtitle"><label for="LR_SJ"> 接收时间 </label></td>
							<td><s:textfield cssClass="text" id="LR_SJ"
									name="fpzwcx.LR_SJ" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="FS_SJ"> 发送时间 </label></td>
							<td><s:textfield cssClass="text" id="FS_SJ"
									name="fpzwcx.FS_SJ" readonly="true"></s:textfield></td>
							<td class="tdtitle"><label for="FSZT_DM"> 发送状态 </label></td>
							<td><s:select disabled="true" id="FSZT_DM"
									name="fpzwcx.FSZT_DM" list="fsztmap" headerKey=""
									headerValue="--选择--" cssStyle="width:210px;"></s:select></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="SMSINFO"> 短信内容 </label></td>
							<td>
								<s:textarea cssClass="text" id="SMSINFO" name="fpzwcx.SMSINFO" rows="5" cols="30" cssStyle="width:300px;height:150px"
                                 readonly="true"></s:textarea>
							</td>
							<td class="tdtitle"><label for="SMSINFO">发送内容</label></td>
							<td>
								<s:textarea cssClass="text" id="SMSINFO" name="fpzwcx.SMSINFO2" rows="5" cols="30" cssStyle="width:300px;height:150px"
                                 readonly="true"></s:textarea>
							</td>
						</tr>
					</table>
