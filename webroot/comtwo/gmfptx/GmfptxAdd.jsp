...
<html>
    <head>
        ...
        <script type="text/javascript">
            $(function() {
                $('#TYDQ_RQ').datepick({yearRange: 'c-50:c+10',showOnFocus:true,triggerImage:'images/calendar.gif',fixedWeeks:true,dateFormat: 'yyyy-mm-dd',showTrigger:'#aaaaa'});
                $('#TYDQ_RQ').css("width","235px");                $('#TY_RQ').datepick({yearRange: 'c-50:c+10',showOnFocus:true,triggerImage:'images/calendar.gif',fixedWeeks:true,dateFormat: 'yyyy-mm-dd',showTrigger:'#aaaaa'});
                $('#TY_RQ').css("width","235px");                $('#LR_SJ').datepick({yearRange: 'c-50:c+10',showOnFocus:true,triggerImage:'images/calendar.gif',fixedWeeks:true,dateFormat: 'yyyy-mm-dd',showTrigger:'#aaaaa'});
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:select id="SWJGBM" name="gmfptx.SWJGBM" list="orgmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="false" requiredsLength="0,50" labels="税务机关" ></s:select>
						</td>
						<td class="tdtitle">
                            <label for="NSRSBM">
                                	纳税人编码
						...
						<td>
                            <s:textfield cssClass="text" id="NSRSBM" name="gmfptx.NSRSBM"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="NSRMC" name="gmfptx.NSRMC"
						...
						<td>
                            <s:select id="SJLX" name="gmfptx.SJLX" list="jsrlxmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="false" requiredsLength="0,20" labels="手机类型" ></s:select>
						</td>
</tr>
<tr>						<td class="tdtitle">
                            <label for="SJHM">
						...
						<td>
                            <s:textfield cssClass="text" id="SJHM" name="gmfptx.SJHM"
						...
						<td>
                            <s:textfield cssClass="text" id="SMSINFO" name="gmfptx.SMSINFO"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="TYDQ_RQ" name="gmfptx.TYDQ_RQ"
						...
						<td>
                            <s:textfield cssClass="text" id="TY_RQ" name="gmfptx.TY_RQ"
                                requireds="false" requiredsLength="0," labels="发票日期"  requiredsType="date" ></s:textfield>
						</td>
</tr>
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="BZ" name="gmfptx.BZ"
						...
						<td>
                            <s:textfield cssClass="text" id="FSZT_DM" name="gmfptx.FSZT_DM"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="LR_SJ" name="gmfptx.LR_SJ"
						...
						<td>
                            <s:textfield cssClass="text" id="FS_SJ" name="gmfptx.FS_SJ"
