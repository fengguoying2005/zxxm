...
<script type="text/javascript">
            function next(event) {
                ...
                document.forms[0].action="<%=basePath%>comtwo/gmfptx_"+event+".html";
                document.forms[0].submit();
            }
			$(function() {
			    $('#FIND_TYDQ_RQ').datepick({yearRange: 'c-50:c+10',showOnFocus:true,triggerImage:'images/calendar.gif',fixedWeeks:true,dateFormat: 'yyyy-mm-dd',showTrigger:'#aaaaa'});
			    $('#FIND_TYDQ_RQ').css("width","185px");   
			    $('#FIND_TY_RQ').datepick({yearRange: 'c-50:c+10',showOnFocus:true,triggerImage:'images/calendar.gif',fixedWeeks:true,dateFormat: 'yyyy-mm-dd',showTrigger:'#aaaaa'});
			    $('#FIND_TY_RQ').css("width","185px");   
			});
        </script>
</head>
<body onload="tablecloth('gmfptxList');">
	<form id="myform" name="myform" action="gmfptx" method="post">
			...
			<div class="span-24">
				...
				<div id="tablediv">
					<table width="100%" class="tablepanel" cellspacing="0">
						...
						<tr>
							<td class="tdtitle"><label for="FIND_TYDQ_RQ"> 发票日期起
							</label></td>
							<td><s:textfield cssClass="text" id="FIND_TYDQ_RQ"
									name="FIND_TYDQ_RQ"></s:textfield></td>
							<td class="tdtitle"><label for="FIND_TY_RQ"> 发票日期止 </label></td>
							<td><s:textfield cssClass="text" id="FIND_TY_RQ"
									name="FIND_TY_RQ"></s:textfield></td>
						</tr>
					</table>
				</div>
				...
				<table class="record-list" id="gmfptxList" name="gmfptxList">
					<thead>
						<tr>
							<th>选择</th>
							<th>行</th>
							...
							<td colspan="8">
								<div align="left">
									<gwintag:page pageBeanName="pageBean"
										includes="FIND_SWJGBM,FIND_NSRSBM,FIND_NSRMC,FIND_SJLX,FIND_TYDQ_RQ,FIND_TY_RQ"
					...
					<tbody>
						<s:iterator value="gmfptxs" status="stat">
							<tr
