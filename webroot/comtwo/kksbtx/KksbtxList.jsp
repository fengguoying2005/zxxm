...
<script type="text/javascript">
            function next(event) {
                ...
                document.forms[0].action="<%=basePath%>comtwo/kksbtx_"+event+".html";
...
<body onload="tablecloth('kksbtxList');">
	<form id="myform" name="myform" action="kksbtx" method="post">
			...
			<div class="span-24">
				...
				<div id="tablediv">
					<table width="100%" class="tablepanel" cellspacing="0">
						...
						<tr>
							<td class="tdtitle"><label for="FIND_KS_RQ"> 发送时间起 </label></td>
							<td><s:textfield cssClass="text" id="FIND_KS_RQ"
									name="FIND_KS_RQ"></s:textfield></td>
							<td class="tdtitle"><label for="FIND_JZ_RQ"> 发送时间止 </label></td>
				...
				<table class="record-list" id="kksbtxList" name="kksbtxList">
					<thead>
						<tr>
							<th>选择</th>
							<th>行</th>
					...
					<tbody>
						<s:iterator value="kksbtxs" status="stat">
							<tr
