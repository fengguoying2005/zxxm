...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:select id="SWJGBM" name="kksbtx.SWJGBM" list="orgmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="false" requiredsLength="0,50" labels="税务机关" ></s:select>
						</td>
						<td class="tdtitle">
                            <label for="NSRSBM">
                                	纳税人编码
						...
						<td>
                            <s:textfield cssClass="text" id="NSRSBM" name="kksbtx.NSRSBM"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="NSRMC" name="kksbtx.NSRMC"
						...
						<td>
                            <s:select id="SJLX" name="kksbtx.SJLX" list="jsrlxmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="false" requiredsLength="0,20" labels="手机类型" ></s:select>
						</td>
</tr>
<tr>						<td class="tdtitle">
                            <label for="SJHM">
						...
						<td>
                            <s:textfield cssClass="text" id="SJHM" name="kksbtx.SJHM"
						...
						<td>
                            <s:textfield cssClass="text" id="SMSINFO" name="kksbtx.SMSINFO"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="SKSSQ" name="kksbtx.SKSSQ"
						...
						<td>
                            <s:textfield cssClass="text" id="SKSSZ" name="kksbtx.SKSSZ"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="JKQX_RQ" name="kksbtx.JKQX_RQ"
						...
						<td>
                            <s:textfield cssClass="text" id="BZ" name="kksbtx.BZ"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="FSZT_DM" name="kksbtx.FSZT_DM"
						...
						<td>
                            <s:textfield cssClass="text" id="LR_SJ" name="kksbtx.LR_SJ"
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="FS_SJ" name="kksbtx.FS_SJ"
						...
						<td>
                            <s:textfield cssClass="text" id="YZPZXH" name="kksbtx.YZPZXH"
                                requireds="false" requiredsLength="0,20" labels="应征凭证序号" ></s:textfield>
						</td>
</tr>
<tr>						<td class="tdtitle">
                            <label for="SF_JE">
						...
						<td>
                            <s:textfield cssClass="text" id="SF_JE" name="kksbtx.SF_JE"
