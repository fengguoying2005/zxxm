...
<script type="text/javascript">
            function next(event) {
                ...
                document.forms[0].action="<%=basePath%>comtwo/tydqtx_"+event+".html";
...
<body onload="tablecloth('tydqtxList');">
	<form id="myform" name="myform" action="tydqtx" method="post">
			...
			<div class="span-24">
				...
				<div id="tablediv">
					<table width="100%" class="tablepanel" cellspacing="0">
						...
						<tr>
							<td class="tdtitle"><label for="FIND_TY_RQ"> 停业日期起 </label></td>
							<td><s:textfield cssClass="text" id="FIND_TY_RQ"
									name="FIND_TY_RQ"></s:textfield></td>
							<td class="tdtitle"><label for="FIND_TYDQ_RQ">
									停业日期止 </label></td>
				...
				<table class="record-list" id="tydqtxList" name="tydqtxList">
					<thead>
						<tr>
							<th>选择</th>
							<th>行</th>
							...
							<td colspan="8">
								<div align="left">
									<gwintag:page pageBeanName="pageBean"
										includes="FIND_SWJGBM,FIND_NSRSBM,FIND_NSRMC,FIND_SJLX,FIND_TY_RQ,FIND_TYDQ_RQ"
					...
					<tbody>
						<s:iterator value="tydqtxs" status="stat">
							<tr
