					...
					<table width="100%" class="tablepanel" cellspacing="0">
						...
						<tr>
							...
							<td><s:textfield cssClass="text" id="SJHM"
									name="tydqtx.SJHM" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td rowspan="7" class="tdtitle"><label for="SMSINFO"> 短信内容 </label></td>
							<td rowspan="7">
								<s:textarea cssClass="text" id="SMSINFO" name="tydqtx.SMSINFO" rows="5" cols="30" cssStyle="width:300px;height:150px"
                                 readonly="true"></s:textarea>
							</td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="TY_RQ"> 停业日期 </label></td>
							<td><s:textfield cssClass="text" id="TY_RQ"
									name="tydqtx.TY_RQ" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="TYDQ_RQ"> 停业到期日期 </label></td>
							<td><s:textfield cssClass="text" id="TYDQ_RQ"
									name="tydqtx.TYDQ_RQ" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="FSZT_DM"> 发送状态 </label></td>
							<td><s:textfield cssClass="text" id="FSZT_DM"
									name="tydqtx.FSZT_DM" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="LR_SJ"> 数据接收时间 </label></td>
							<td><s:textfield cssClass="text" id="LR_SJ"
									name="tydqtx.LR_SJ" readonly="true"></s:textfield></td>
						</tr>
						<tr>
							<td class="tdtitle"><label for="FS_SJ"> 发送时间 </label></td>
							<td><s:textfield cssClass="text" id="FS_SJ"
									name="tydqtx.FS_SJ" readonly="true"></s:textfield></td>
							</div>
						</tr>
						</div>
					</table>
