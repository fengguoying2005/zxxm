...
<script type="text/javascript">
            $(function() {
                $('#KTRQQ').datepick({yearRange: 'c-50:c+10',showOnFocus:true,triggerImage:'images/calendar.gif',fixedWeeks:true,dateFormat: 'yyyy-mm-dd',showTrigger:'#aaaaa'});
                $('#KTRQQ').css("width","185px");                
                $('#KTRQZ').datepick({yearRange: 'c-50:c+10',showOnFocus:true,triggerImage:'images/calendar.gif',fixedWeeks:true,dateFormat: 'yyyy-mm-dd',showTrigger:'#aaaaa'});
                $('#KTRQZ').css("width","185px");            
            });
            function next(event) {
                var isOk = true;
                if(event=="mod") {
					...
					<table width="100%" class="tablepanel" cellspacing="0">
						<tr>
							...
							<td align="left"><s:textfield cssClass="text" id="NSRBM"
									...
									labels="纳税人编码" readonly="true"></s:textfield>
							</td>
						...
						<tr>
							...
							<td align="left"><s:textfield cssClass="text" id="KTRQQ"
									name="xydz.KTRQQ" requireds="true" requiredsLength="0,20"
									labels="开通日期起"></s:textfield></td>
							<td class="tdtitle"><label for="KTRQZ"> 开通日期止 </label></td>
							<td align="left"><s:textfield cssClass="text" id="KTRQZ"
									name="xydz.KTRQZ" requireds="true" requiredsLength="0,20"
						...
						<tr>
							...
							<td align="left" colspan="3"><s:textfield cssClass="text" id="BZ" name="xydz.BZ"
