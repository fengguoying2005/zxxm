...
f("#"+b.tId+G).length>0)){var c=f("#"+b.tId+u),e="<button class='remove' id='"+b.tId+G+"' title='' onfocus='this.blur();' style='display:none;'></button>";c.append(e);var d=f("#"+b.tId+G);if(a.treeObj.attr("offsetLeft")+a.treeObj.attr("offsetWidth")-c.attr("offsetLeft")-c.attr("offsetWidth")-1*d.width()-15<0){d.remove();c.prepend(e);d=f("#"+b.tId+G)}f("#"+b.tId+G).bind("click",function(){var g=true;if(typeof a.callback.beforeRemove=="function")g=a.callback.beforeRemove(a.treeObjId,b);if(g!=false){ua(a,
b);f("#"+a.treeObjId).trigger(X,[a.treeObjId,b]);return false}}).bind("mousedown",function(){return true}).show()}}function v(a,b,c){if(b){b.removeClass();a=a.checkStyle+"_"+(c.checkedNew?Ka:La)+"_"+(c.checkedNew||a.checkStyle==E?c.check_True_Full?va:wa:c.check_False_Full?va:wa);a=c.checkboxFocus?a+"_"+Ma:a;b.addClass(Na);b.addClass(a)}}function N(a,b){if(b&&b.parentNode){xa(a,b.parentNode);N(a,b.parentNode)}}function oa(a,b){b[a.nodesCol]&&b[a.nodesCol].length>0?N(a,b[a.nodesCol][0]):N(a,b)}function fa(a,
b){if(b&&b[a.nodesCol]){for(var c=0;c<b[a.nodesCol].length;c++)b[a.nodesCol][c][a.nodesCol]&&fa(a,b[a.nodesCol][c]);xa(a,b)}}function xa(a,b){if(b&&b[a.nodesCol]){for(var c=true,e=true,d=0;d<b[a.nodesCol].length;d++){if(a.checkStyle==E&&(b[a.nodesCol][d].checkedNew||!b[a.nodesCol][d].check_True_Full))c=false;else if(a.checkStyle!=E&&b.checkedNew&&(!b[a.nodesCol][d].checkedNew||!b[a.nodesCol][d].check_True_Full))c=false;else if(a.checkStyle!=E&&!b.checkedNew&&(b[a.nodesCol][d].checkedNew||!b[a.nodesCol][d].check_False_Full))e=
false;if(!c||!e)break}b.check_True_Full=c;b.check_False_Full=e;c=f("#"+b.tId+"_check");v(a,c,b)}}function Q(a){var b=i[a.data.treeObjId];a=a.data.treeNode;b.expandTriggerFlag=true;if(a.open){var c=true;if(typeof b.callback.beforeCollapse=="function")c=b.callback.beforeCollapse(b.treeObjId,a);if(c==false){b.expandTriggerFlag=false;return}}else{c=true;if(typeof b.callback.beforeExpand=="function")c=b.callback.beforeExpand(b.treeObjId,a);if(c==false){b.expandTriggerFlag=false;return}}ya(b,a)}function ya(a,
b){if(b&&b[a.nodesCol]&&b[a.nodesCol].length>0)x(a,b,!b.open);else a.async&&!a.editable&&za(a,b);if(window.event)window.event.returnValue=null;return false}function za(a,b){for(var c="",e=0;b&&e<a.asyncParam.length;e++)c+=(c.length>0?"&":"")+a.asyncParam[e]+"="+b[a.asyncParam[e]];for(e=0;e<a.asyncParamOther.length;e+=2)c+=(c.length>0?"&":"")+a.asyncParamOther[e]+"="+a.asyncParamOther[e+1];f.ajax({type:"POST",url:a.asyncUrl,data:c,success:function(d){if(!(!d||d.length==0)){var g="";try{g=eval("("+
d+")")}catch(p){}g&&g!=""&&Aa(a,b,g,false);f("#"+a.treeObjId).trigger(aa,[a.treeObjId,b,d])}},error:function(d,g,p){a.expandTriggerFlag=false;f("#"+a.treeObjId).trigger(ba,[a.treeObjId,b,d,g,p])}})}function x(a,b,c,e,d){if(!b||b.open==c)typeof d=="function"&&d();else{if(a.expandTriggerFlag){d=function(){b.open?f("#"+a.treeObjId).trigger(Z,[a.treeObjId,b]):f("#"+a.treeObjId).trigger($,[a.treeObjId,b])};a.expandTriggerFlag=false}c=f("#"+b.tId+r);var g=f("#"+b.tId+t),p=f("#"+b.tId+s);if(b.isParent&&
b[a.nodesCol]&&b[a.nodesCol].length>0)if(b.open){n(c,A);F(g,A);b.open=false;if(e==false){p.hide();typeof d=="function"&&d()}else p.hide(a.expandSpeed,d)}else{n(c,z);F(g,z);b.open=true;if(e==false){p.show();typeof d=="function"&&d()}else p.show(a.expandSpeed,d)}}}function ka(a,b,c,e,d){var g=b?b[a.nodesCol]:a.root[a.nodesCol],p=b?false:e;if(g)for(var q=0;q<g.length;q++)g[q]&&ka(a,g[q],c,p);x(a,b,c,e,d)}function L(a,b,c,e,d){if(b.parentNode){x(a,b,c,e);b.parentNode&&L(a,b.parentNode,c,e,d)}else x(a,
b,c,e,d)}function ga(a,b,c){var e=f("#"+b.tId+"_check");b.checkedNew=c;v(a,e,b);if(b.parentNode){e=true;if(!c)for(var d=0;d<b.parentNode[a.nodesCol].length;d++)if(b.parentNode[a.nodesCol][d].checkedNew){e=false;break}e&&ga(a,b.parentNode,c)}}function ea(a,b,c){if(b){var e=f("#"+b.tId+"_check");b.checkedNew=c;v(a,e,b);if(b[a.nodesCol])for(e=0;e<b[a.nodesCol].length;e++)b[a.nodesCol][e]&&ea(a,b[a.nodesCol][e],c)}}function Ba(a,b,c){if(c){c.level=b?b.level+1:0;if(c[a.nodesCol])for(b=0;b<c[a.nodesCol].length;b++)c[a.nodesCol][b]&&
Ba(a,c,c[a.nodesCol][b])}}function Aa(a,b,c,e){if(b){if(f("#"+a.treeObjId).find("#"+b.tId).length!=0){target_switchObj=f("#"+b.tId+r);target_icoObj=f("#"+b.tId+t);target_aObj=f("#"+b.tId+u);target_ulObj=f("#"+b.tId+s);if(!b.open){n(target_switchObj,A);F(target_icoObj,A);b.open=false;target_ulObj.css({display:"none"})}if(!b.isParent){target_switchObj.unbind("click");target_switchObj.bind("click",function(){x(a,b,!b.open)});target_aObj.unbind("dblclick");target_aObj.bind("dblclick",{treeObjId:a.treeObjId,
treeNode:b},Q)}Ca(a,b,c);H(a,b.level+1,c,b);e||L(a,b,true)}}else{Ca(a,a.root,c);H(a,0,c,null)}}function Ca(a,b,c){b[a.nodesCol]||(b[a.nodesCol]=[]);if(b[a.nodesCol].length>0){var e=b[a.nodesCol][b[a.nodesCol].length-1].tId;b[a.nodesCol][b[a.nodesCol].length-1].isLastNode=false;b[a.nodesCol][b[a.nodesCol].length-1].isFirstNode?n(f("#"+e+r),C):n(f("#"+e+r),P);f("#"+e+s).addClass(D)}b.isParent=true;b[a.nodesCol]=b[a.nodesCol].concat(c)}function ta(a,b,c,e){if(b!=c){var d=c.parentNode==null?a.root:c.parentNode,
g=b===null||b==a.root;if(g&&b===null)b=a.root;var p=f("#"+c.tId+r),q=f("#"+c.tId+s),k,h,j,m;if(g)k=k=f("#"+a.treeObjId);else{h=f("#"+b.tId+r);j=f("#"+b.tId+t);m=f("#"+b.tId+u);k=f("#"+b.tId+s)}n(h,z);F(j,z);b.open=true;k.css({display:"block"});if(!b.isParent&&!g){h.unbind("click");h.bind("click",function(){x(a,b,!b.open)});m.unbind("dblclick");m.bind("dblclick",{treeObjId:a.treeObjId,treeNode:b},Q)}k.append(f("#"+c.tId).detach());h=-1;for(j=0;j<d[a.nodesCol].length;j++)if(d[a.nodesCol][j].tId==c.tId)h=
j;h>=0&&d[a.nodesCol].splice(h,1);if(b[a.nodesCol]){if(a.showLine&&b[a.nodesCol].length>0){b[a.nodesCol][b[a.nodesCol].length-1].isLastNode=false;h=f("#"+b[a.nodesCol][b[a.nodesCol].length-1].tId+s);j=f("#"+b[a.nodesCol][b[a.nodesCol].length-1].tId+r);h.addClass(D);g&&b[a.nodesCol][b[a.nodesCol].length-1].isFirstNode?n(j,C):n(j,P)}}else b[a.nodesCol]=[];if(g)c.parentNode=null;else{b.isParent=true;c.parentNode=b}Ba(a,c.parentNode,c);b[a.nodesCol].splice(b[a.nodesCol].length,0,c);c.isLastNode=true;
c.isFirstNode=b[a.nodesCol].length==1;if(a.showLine){n(p,y);q.removeClass(D)}if(d[a.nodesCol].length<1){d.isParent=false;h=f("#"+d.tId+s);j=f("#"+d.tId+r);c=f("#"+d.tId+t);n(j,w);F(c,w);h.css("display","none")}else if(a.showLine){d[a.nodesCol][d[a.nodesCol].length-1].isLastNode=true;d[a.nodesCol][d[a.nodesCol].length-1].isFirstNode=d[a.nodesCol].length==1;h=f("#"+d[a.nodesCol][d[a.nodesCol].length-1].tId+s);j=f("#"+d[a.nodesCol][d[a.nodesCol].length-1].tId+r);c=f("#"+d[a.nodesCol][d[a.nodesCol].length-
1].tId+t);if(d==a.root)if(d[a.nodesCol].length==1)n(j,O);else{d=f("#"+d[a.nodesCol][0].tId+r);n(d,C);n(j,y)}else n(j,y);h.removeClass(D)}L(a,b,true,e)}}function ua(a,b){var c=b.parentNode==null?a.root:b.parentNode;if(a.curTreeNode===b)a.curTreeNode=null;if(a.curEditTreeNode===b)a.curEditTreeNode=null;f("#"+b.tId).remove();for(var e=-1,d=0;d<c[a.nodesCol].length;d++)if(c[a.nodesCol][d].tId==b.tId)e=d;e>=0&&c[a.nodesCol].splice(e,1);if(c[a.nodesCol].length<1){c.isParent=false;e=f("#"+c.tId+s);d=f("#"+
...
(c.root[c.nodesCol]=[]);ca=0;if(b)c.root[c.nodesCol]=b;i[c.treeObjId]=c;f("#"+c.treeObjId).empty();if(c.root[c.nodesCol]&&c.root[c.nodesCol].length>0)H(c,0,c.root[c.nodesCol]);else c.async&&c.asyncUrl&&c.asyncUrl.length>0&&za(c);Ga(c,this);return(new Pa).init(this)};var T=[]})(jQuery);