        ...
        var dfop =
            {
                 ...
                 */
                cbiconpath: "js/wdTree/css/images/icons/",
                    ...
                    if (ul.hasClass("bbit-tree-node-ct")) {
                        ...
                        if (item.complete) {
                            ...
                            asnyloadc(item, true, function(data) {
                            	//alert(eval('('+data.result+')').length);
                            	//alert(JSON.parse(str));
                            	//data = eval('('+"[{'id':'A','text':'AAA','hasChildren':true,'showcheck':true,'isexpand':false,'complete':false,'value':'AA','checkstate':0}]"+')');
                            	data = eval('('+data.result+')');
                            	//alsert(JSON2.stringify(data));
                            	//alert(data.length);
                                item.complete = true;
                                item.ChildNodes = data;
                                //alert(JSON2.parse(JSON2.stringify(data.result))[0]);
                            	//alert(JSON2.stringify(data.result));
