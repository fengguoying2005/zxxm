    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function importFile() {
                ...
                frm.action="<%=basePath%>nsrsms/cbimport_importfile.html";
            ...
            function exportFile() {
            	 var frm = document.myform;
                 frm.action="<%=basePath%>nsrsms/cbexport_export.html";
                 frm.submit();
            }
        </script>
    </head>
        ...
        <form id="myform" name="myform" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="span-24">
                ...
                <div align="center">
                    ...
                    <br><input id="importFileBtn" type="button" value="导入催报" onClick="importFile()"  class="buttonface"/>&nbsp;&nbsp;
