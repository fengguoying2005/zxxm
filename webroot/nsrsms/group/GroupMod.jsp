...
<script type="text/javascript" src="<%=request.getContextPath()%>/jeasyui/locale/easyui-lang-zh_CN.js"></script>
        ...
        <script type="text/javascript">
        	...
        	function msgdateformat(value,row) {
				if (value == null || value == '') {
					return '';
				}
				var dt;
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:select disabled="true" id="SMSTYPE_DM" name="group.SMSTYPE_DM" list="smstypemap" headerKey="" headerValue="--选择--" cssStyle="width:250px;" requireds="false" requiredsLength="1,2" labels="短信类型" ></s:select>
						</td>
						<td class="tdtitle">
...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:select disabled="true" id="ORG_DM_JG" name="group.ORG_DM_JG" list="orgmap" headerKey="" headerValue="--选择--" cssStyle="width:250px;" requireds="false" requiredsLength="1,20" labels="税务机关" ></s:select>
						</td>
						<td class="tdtitle">
                            <label for="SMSZT_DM">
                                	短信状态
						...
						<td>
                            <s:select disabled="true" id="SMSZT_DM" name="group.SMSZT_DM" list="smsztmap" headerKey="" headerValue="--选择--" cssStyle="width:260px;" requireds="false" requiredsLength="0,2" labels="短信状态" ></s:select>
						</td>
                    </div>
</tr>                    </div>
                </table>
                ...
                <div align="center">
                    ...
                    <br><input disabled="disabled" id="modBtn" type="button" value="保存" onClick="next('mod')"  class="buttonface"/>
