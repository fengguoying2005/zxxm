	    ...
	    <thead>  
	        <tr>  									
				...
				<s:else>
					...
					<th data-options="field:'SMSTYPE_DM',width:70,formatter:msgformat" editor='text'>发送状态</th>
					<th data-options="field:'FS_SJ',width:140,formatter:msgformat" editor='text'>发送时间</th>
						...
						<tbody id="tbody">
							<s:iterator value="tablemx" status="stat">
								<tr class='<s:property value="%{((#stat.index+1)%2==1)?'even':'odd'}"/>'>
									...
									<s:else>
										<s:text name="%{'tablemx['+#stat.index+'].MSG'}"></s:text></td>
										<td><s:text name="%{'tablemx['+#stat.index+'].SMSTYPE_DM'}"></s:text></td>
										<td><s:text name="%{'tablemx['+#stat.index+'].FS_SJ'}"></s:text></td>
										<td><s:text name="%{'tablemx['+#stat.index+'].FSCS'}"></s:text>
									</s:else>
									</td>
