				...
				<fieldset>
					...
					<div class="span-11">
						<div>
							...
							<s:textfield cssClass="text readonly" id="ACCOUNT" name="user.ACCOUNT" readonly="true"></s:textfield>
						</div>
						<div>
