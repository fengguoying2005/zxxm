...
<script type="text/javascript">
            ...
            function next(event) {
                ...
                if(isOk) {
                    ...
                    frm.action="<%=basePath%>qxgl/user2_"+event+".html";
                    frm.submit();
                }
            }
            function changebm() {
...
<s:hidden cssClass="displaynone" id="USER_DM" name="user.USER_DM" requiredsLength="1,20" labels="用户编码" readonly="true"></s:hidden>
...
<table width="100%" class="tablepanel" cellspacing="0">
	...
	<tr>
		...
		<td>
            <s:select id="ZW_DM" name="user.ZW_DM" list="zwmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="true" requiredsLength="0,20" labels="职务" ></s:select>
		</td>
		...
		<td><s:select id="XB_DM" name="user.XB_DM" list="xbmap"
			...
			requireds="true" requiredsLength="0,1" labels="性别"></s:select></td>
	</tr>
	<tr>
