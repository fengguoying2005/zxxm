...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            function toback() {
                ...
                frm.action="<%=basePath%>qxgl/user2_list.html";
				frm.submit();
            }
            function next(event) {
            }
            function importFile() {
                var frm = document.myform;
                frm.action="<%=basePath%>qxgl/user2import_importfile.html";
            ...
            function exportFile() {
            	 var frm = document.myform;
                 frm.action="<%=basePath%>qxgl/user2export_export.html";
                 frm.submit();
            }
        </script>
    </head>
    <body  onload="tablecloth('TABLEMX_1');initReadOnly();">
        <form id="myform" name="myform" action="" method="post" enctype="multipart/form-data">
            ...
            <s:hidden id="fileName" name="fileName" value="内部人员模板.xls"></s:hidden>
            <div class="span-24">
                ...
                <div align="center">
                    ...
                    <br><input id="importFileBtn" type="button" value="导入内部人员" onClick="importFile()"  class="buttonface"/>&nbsp;&nbsp;
                    <input id="exportFileBtn" type="button" value="下载模板" onClick="exportFile()"  class="buttonface"/>&nbsp;&nbsp;
                    <input id="exportFileBtn" type="button" value="返回" onClick="toback()"  class="buttonface"/>
                </div>
            </div>
            </div>
        </form>
