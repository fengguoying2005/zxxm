    ...
    <head>
        ...
        <script type="text/javascript">
            function next(event) {
                ...
                if("toAdd"!=event && "list"!=event && "printExcel"!=event &&"printWord"!=event && "importExcel"!=event) {
                ...
                document.forms[0].action="<%=basePath%>qxgl/user2_"+event+".html";
                            ...
                            <tr>
                                <td colspan="8">
                                    ...
                                    <div align="right">
                                        ...
                                        <input class="buttonface" type="button" value="内部人员导入"
                                            onClick="next('importExcel')" />
                                    </div>
                                </td>
                            </tr>
                        </tfoot>
