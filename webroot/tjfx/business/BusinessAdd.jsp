...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:select id="ORG_DM_JG" name="business.ORG_DM_JG" list="orgmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="true" requiredsLength="1,20" labels="税务机关" ></s:select>
						</td>
						<td class="tdtitle">
						...
						<td>
                            <s:select id="SMSTYPE_DM" name="business.SMSTYPE_DM" list="smstypemap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="true" requiredsLength="1,2" labels="短信类型" ></s:select>
						</td>
</tr>
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:textfield cssClass="text" id="GROUP_NAME" name="business.GROUP_NAME"
						...
						<td>
                            <s:select id="SMSZT_DM" name="business.SMSZT_DM" list="smsztmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" requireds="false" requiredsLength="0,2" labels="短信状态" ></s:select>
						</td>
</tr>
<tr>						<td class="tdtitle">
                            <label for="LRRY_DM">
						...
						<td>
                            <s:textfield cssClass="text" id="LRRY_DM" name="business.LRRY_DM"
                                requireds="false" requiredsLength="0,20" labels="录入人员" ></s:textfield>
						</td>
						<td class="tdtitle">
                            <label for="LR_SJ">
                                	录入时间
						...
						<td>
                            <s:textfield cssClass="text" id="LR_SJ" name="business.LR_SJ"
                                requireds="false" requiredsLength="0," labels="录入时间"  requiredsType="date" ></s:textfield>
						</td>
                    </div>
</tr>                    </div>
                </table>
