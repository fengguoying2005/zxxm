...
<script type="text/javascript">
            function next(event) {
                ...
                document.forms[0].action="<%=basePath%>tjfx/business_"+event+".html";
...
<body onload="tablecloth('businessList');">
<form id="myform" name="myform" action="business" method="post">
...
<table width="100%" class="tablepanel" cellspacing="0">
	<tr>
		<td class="tdtitle"><label for="FIND_ORG_DM_JG"> 税务机关 </label></td>
		<td><s:select id="FIND_ORG_DM_JG" name="FIND_ORG_DM_JG"
...
<table class="record-list" id="businessList" name="businessList">
	<thead>
		<tr>
			<th>选择</th>
			<th>行</th>
	...
	<tfoot>
		<tr>
			...
			<div align="left"><gwintag:page pageBeanName="pageBean"
				includes="FIND_ORG_DM_JG,FIND_SMSTYPE_DM,FIND_GROUP_NAME,FIND_SMSZT_DM,FIND_KS_RQ,FIND_JZ_RQ"
	...
	<tbody>
		<s:iterator value="businesss" status="stat">
			<tr
