...
<tr>						<td class="tdtitle">
						...
						<td>
                            <s:select disabled="true" id="ORG_DM_JG" name="dxmb.ORG_DM_JG" list="orgjgmap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" ></s:select>
						</td>
						<td class="tdtitle">
						...
						<td>
                            <s:select disabled="true" id="SMSTYPE_DM" name="dxmb.SMSTYPE_DM" list="smstypemap" headerKey="" headerValue="--选择--" cssStyle="width:210px;" ></s:select>
						</td>
</tr>
<tr>						<td class="tdtitle">
                            <label for="DXMB_MC">
