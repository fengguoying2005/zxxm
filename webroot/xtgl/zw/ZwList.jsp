    ...
    <head>
        ...
        <script type="text/javascript">
            function next(event) {
                ...
                document.forms[0].action="<%=basePath%>xtgl/zw_"+event+".html";
                document.forms[0].submit();
            }
        </script>
    </head>
    <body onload="tablecloth('zwList');">
        <form id="myform" name="myform" action="zw" method="post">
            <div class="container" id="mainframe">
                <s:hidden id="ZW_DM" name="ZW_DM"></s:hidden>
                <div class="span-24">
                    ...
                    <table class="record-list" id="zwList" name="zwList">
                        <thead>
                            <tr>
                                <th>
                                    选择
                        ...
                        <tbody>
                            <s:iterator value="zws" status="stat">
                                <tr
                                    class="<s:property value="%{((#stat.index+1)%2==1)?'even':'odd'}"/>">
                                    <td>
                                        <INPUT type="radio" name='radio'
                                            value='<s:property value="ZW_DM" />' />
                                    </td>
                                    <td>
                                        <s:property value="#stat.index+1" />
                                    </td>
                                    <td>
                                        <s:property value="ZW_DM" />
                                    </td>
                                    <td>
                                        <s:property value="ZW_MC" />
                                    </td>
                                    <td>
                                        <s:property value="BZ" />
                                    </td>
